...
if (isset($_POST['submit'])) {
  ...
  if ($query1->rowCount() == 0) {
    ...
    if ($lastInsertId) {
      ...
      echo "<script type='text/javascript'> document.location = 'rental_list.php'; </script>";
    }
  } else {
  ...
  <main id="main">
    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        ...
        $sql = "SELECT tblTools.*,tblbrands.BrandName,tblbrands.id as bid  from tblTools join tblbrands on tblbrands.id=tblTools.ToolsBrand where tblTools.id=:vhid";
        $query = $dbh->prepare($sql);
        $query->bindParam(':vhid', $vhid, PDO::PARAM_STR);
        $query->execute();
        ...
        ?>
            <div class="owl-carousel clients-carousel">
              <img src="admin/img/<?php echo htmlentities($result->Vimage1); ?>" alt="" style="height: 150px; width:300px;">
            </div>
      </div>
    </section><!-- #clients -->
    ...
    <section class="listing-detail">
      <div class="container">
        <div class="listing_detail_head row">
          <div class="col-md-9">
            <h2><?php echo htmlentities($result->BrandName); ?> , <?php echo htmlentities($result->ToolsTitle); ?></h2>
          </div>
          <div class="col-md-3">
              ...
              <div class="listing_detail_wrap">
                ...
                <div class="tab-content">
                  ...
                  <div role="tabpanel" class="tab-pane active" id="vehicle-overview">
                    ...
                    <p><?php echo htmlentities($result->ToolsOverview); ?></p>
                  </div>
        ...
        <!-- <div class="similar_cars">
          ...
          <div class="row">
            <?php
            $bid = $_SESSION['brndid'];
            $sql = "SELECT tblTools.ToolsTitle,tblbrands.BrandName,tblTools.PricePerDay,tblTools.FuelType,tblTools.ModelYear,tblTools.id,tblTools.SeatingCapacity,tblTools.ToolsOverview,tblTools.Vimage1 from tblTools join tblbrands on tblbrands.id=tblTools.ToolsBrand where tblTools.ToolsBrand=:bid";
            $query = $dbh->prepare($sql);
            ...
            ?>      
                <div class="col-md-3 grid_listing">
                  <div class="product-listing-m gray-bg">
                    <div class="product-listing-img"> <a href="rental_details.php?vhid=<?php echo htmlentities($result->id); ?>"><img src="admin/img/<?php echo htmlentities($result->Vimage1); ?>" class="img-responsive" style="height: 200px; width: 360px;" alt="image" /> </a>
                    </div>
                    <div class="product-listing-content">
                      <h5><a href="rental_details.php?vhid=<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->BrandName); ?> , <?php echo htmlentities($result->ToolsTitle); ?></a></h5>

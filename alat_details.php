    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Detail Alat</h2>
          <p>Kam Menyediakan alat yang sangat berkualitas dan sudah bekerjasama dengan brand ternama, jangan lupa cek deskripsi alat untuk tau detail lebih lanjut</p>
        </div>
        <?php

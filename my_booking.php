...
?>
  ...
  <head>
    <meta charset="utf-8">
    <title>rental Portal | My Booking</title>
                ...
                <div class="col-md-3 col-sm-3">
                  ...
                  <div class="col-md-8 col-sm-8">
                    <div class="profile_wrap">
                      ...
                      <div class="my_Tools_list">
                        <ul class="vehicle_listing">
                          <?php
                          $useremail = $_SESSION['login'];
                          $sql = "SELECT tblTools.Vimage1 as Vimage1,tblTools.ToolsTitle,tblTools.id as vid,tblbrands.BrandName,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.Status,tblTools.PricePerDay,DATEDIFF(tblbooking.ToDate,tblbooking.FromDate) as totaldays,tblbooking.BookingNumber  from tblbooking join tblTools on tblbooking.VehicleId=tblTools.id join tblbrands on tblbrands.id=tblTools.ToolsBrand where tblbooking.userEmail=:useremail";
                          $query = $dbh->prepare($sql);
                          $query->bindParam(':useremail', $useremail, PDO::PARAM_STR);
                          $query->execute();
                          $results = $query->fetchAll(PDO::FETCH_OBJ);
                          ...
                          ?>
                              ...
                              <li>
                                ...
                                <div class="vehicle_img"> <a href="rental_details.php?vhid=<?php echo htmlentities($result->vid); ?>"><img src="admin/img/<?php echo htmlentities($result->Vimage1); ?>" alt="image"></a> </div>
                                <div class="vehicle_title">

                                  <h6><a href="rental_details.php?vhid=<?php echo htmlentities($result->vid); ?>"> <?php echo htmlentities($result->BrandName); ?> , <?php echo htmlentities($result->ToolsTitle); ?></a></h6>
                              ...
                              <table>
                                ...
                                <tr>
                                  <td><?php echo htmlentities($result->ToolsTitle); ?>, <?php echo htmlentities($result->BrandName); ?></td>

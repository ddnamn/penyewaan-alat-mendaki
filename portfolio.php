...
<head>
  <meta charset="utf-8">
  <title>ToolsRental Portal - Gallery</title>
...
<body id="body">
  ...
  <section id="innerBanner">
    <div class="inner-content">
      <h2><span>Portfolio</span><br>We provide high quality product</h2>
      <div>
      </div>
    </div>
  </section><!-- #Page Banner -->
    ...
    <section id="portfolio" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          ...
          <p>berikut adalah galeri yang berupa kumpulan gambar produk berkualitas yang ada di toko kami</p>
        </div>
      </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/kariel1.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/image1.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/image3.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/kariel3.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/kariel2.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/image4.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/image5.png" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="admin/img/image2.png " class="portfolio-popup">

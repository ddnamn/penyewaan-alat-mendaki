<header id="header">
  <div class="container">
    ...
    <div id="logo" class="pull-left">
      <h1><a href="index.html" id="body" class="scrollto"><span style="color: red;">Pendaki</span>.com</a></h1>
    ...
    <div class="pull-left ml-4">
      ...
      <form class="form-inline " action="search.php" method="post">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" type="text" name="searchdata" placeholder="Cari Alat Pendaki" aria-label="Search" required="true">
